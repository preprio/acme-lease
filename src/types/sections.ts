import { PageQuery, ProductQuery } from "@/gql/graphql";
...
// Extract the content type from the PageQuery and ProductQuery
type PageContentItem = NonNullable<PageQuery['Page']>['content'][number];
type ProductContentItem = NonNullable<ProductQuery['Product']>['content'][number];

// Union of all possible content items with guaranteed _id field
export type SectionData = WithRequiredId<PageContentItem> | WithRequiredId<ProductContentItem>;
