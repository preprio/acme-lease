                ...
                <div className='space-y-8'>
                    ...
                    <div className='flex flex-wrap justify-between gap-8 gap-y-16'>
                        <div className='w-full max-w-[468px] space-y-8'>
                            <div className='w-full grow space-y-2.5'>
                                <div className='h-3 w-full max-w-[468px] rounded-xs bg-neutral-100'></div>
                                <div className='h-3 w-full max-w-[396px] rounded-xs bg-neutral-100'></div>
                                <div className='h-3 w-full max-w-[432px] rounded-xs bg-neutral-100'></div>
                            </div>
                            <Button
                                buttonStyle={'primary'}
                                className='uppercase'
                            ...
                            <ul>
                                <li className='w-full max-w-[600px]'>
                                    <div className='relative pb-[65px]'>
                                        <span
                                            className='absolute top-4 left-7 -ml-px h-full w-0.5 bg-blue-50'
                                            aria-hidden='true'
                                        ></span>
                                        <div className='relative flex w-full gap-8'>
                                            ...
                                            <div className='w-full max-w-72 min-w-0 flex-col space-y-6 pt-6'>
                                                <div className='h-4 w-full max-w-40 rounded-xs bg-neutral-100'></div>

                                                <div className='w-52 space-y-2.5 md:w-60 lg:w-72'>
                                                    <div className='h-3 w-full max-w-72 rounded-xs bg-neutral-50'></div>
                                                    <div className='h-3 w-full max-w-64 rounded-xs bg-neutral-50'></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
