...
export default function ExplanationSection({ title, context }: { title?: string, context?: string }) {
            ...
            <Container className="py-10 lg:py-20" data-prepr-variant-key={context}>
                <div className="flex flex-col items-center justify-center gap-12 text-center">
                    <div className="space-y-16">
                        ...
                        <div
                            className="flex flex-wrap items-center justify-center gap-8 gap-y-12 md:gap-14 lg:gap-20">
                            <Step />
                            <Step />
                            <Step />
                        </div>
                    ...
                    <div
                        className="flex aspect-video w-full max-w-3xl items-center justify-center rounded-lg bg-blue-100">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-[64px] w-[64px] md:h-[72px] md:w-[72px] lg:h-[86px] lg:w-[86px]"
                            viewBox="0 0 86 86"
                            fill="none">
                            <circle cx="43" cy="43" r="43" fill="#2563EB" />
                            <path
        ...
        <div className="flex gap-4">
            <svg
                ...
                <path
                    ...
                    fill="#DBEAFE"
                />
                <circle cx="22.1625" cy="30.8422" r="5.78313" fill="#DBEAFE" />
            </svg>
            <div>
                <div className="mb-6 h-4 w-24 rounded-sm bg-neutral-100"></div>
                <div className="space-y-2.5">
                    <div className="h-3 w-44 rounded-sm bg-neutral-50"></div>
                    <div className="h-3 w-40 rounded-sm bg-neutral-50"></div>
                </div>
            </div>
        </div>
    )
